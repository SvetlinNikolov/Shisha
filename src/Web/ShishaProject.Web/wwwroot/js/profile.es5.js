...
var profileDataBtn = document.getElementById('profile-info-container-btn');
var orderHistoryBtn = document.getElementById('profile-orders-container-btn');
var profileDataContent = document.getElementById('profile-info-container');
var orderHistoryContent = document.getElementById('profile-orders-container');
var language = document.getElementById('page_language').innerText;
...
function navigatePageNavigation(clickedElement) {
    // Get all buttons
    var pageNavigationButtons = document.querySelectorAll('.profile-order-pagination button');

    // Define overwritable variables
    var currentActiveIndex = undefined;
    var indexToMakeActive = undefined;
...
function updatePageNavigation() {
    ...
    var currentPage = document.querySelector('.profile-order-pagination button.active');
...
function updateOrders() {
    ...
    var currentPageNumber = document.querySelector('.profile-order-pagination button.active').innerHTML;
    ...
    postRequestHTML('User/UserProfile', data).then(function (results) {
        var ordersContainer = document.querySelector('.profile-orders-container');
...
// Add event listeners
profileDataBtn.addEventListener('click', function (event) {
    return changeProfileNav(event, 'profileData');
});
orderHistoryBtn.addEventListener('click', function (event) {
    return changeProfileNav(event, 'orderHistory');
});
...
function pageNavigation() {
    ...
    try {
        for (var _iterator = pageNavigationButtons[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
